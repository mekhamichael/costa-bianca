...
/////////////////////////////////////////////////////////////////////////////////////////////
handleDiv('count1', 'count1', 10);  // الديف الأول يبدأ من 50
handleDiv('count2', 'count2', 20); // الديف الثاني يبدأ من 100
handleDiv('count3', 'count3', 30); // الديف الثالث يبدأ من 150
handleDiv('count4', 'count4', 40); // الديف الثالث يبدأ من 150
handleDiv('count5', 'count5', 50); // الديف الثالث يبدأ من 150
handleDiv('count6', 'count6', 60); // الديف الثالث يبدأ من 150
handleDiv('count7', 'count7', 70); // الديف الثالث يبدأ من 150
handleDiv('count8', 'count8', 80); // الديف الثالث يبدأ من 150
handleDiv('count9', 'count9', 90); // الديف الثالث يبدأ من 150